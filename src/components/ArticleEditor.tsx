                ...
                <div className="border-t pt-4">
                    <div className="flex justify-between items-center mb-3">
                        ...
                        <div className="flex gap-2">
                            ...
                            <button onClick={() => addBlock('html')} className="text-xs px-2 py-1 bg-slate-200 text-slate-800 rounded hover:bg-slate-300 font-mono">+ HTML</button>
                        </div>
                    </div>
                            ...
                            <div key={index} className="border border-slate-200 rounded-lg p-3 relative">
                                ...
                                {block.type === 'image' ? (
                                    ...
                                    <textarea
                                        value={block.value as string}
                                        onChange={(e) => updateBlock(index, e.target.value)}
                                        className="w-full px-2 py-2 border border-slate-300 rounded text-sm font-mono bg-slate-50"
                                        rows={6}
                                        placeholder="<div class='article-card'>Вставте ваш HTML код сюди...</div>"
                                    />
                                ) : (
                                    <textarea
                                        value={block.value as string}
